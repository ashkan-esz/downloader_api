...
export function sortPosters(posters) {
    const posterSources = ['digimovie', 'film2movie', 'film2media', 'salamdl', 'golching', 'https://poster.', 'avamovie', 'anime-list', 'animelist', 'nineanime', 'bia2anime', 'ba2hd'];
    let sortedPosters = [];
...
function sortTrailers(trailers) {
    const trailerSources = ['digimovie', 'avamovie', 'anime-list', 'animelist', 'film2movie', 'salamdl', 'ba2hd', 'nineanime', 'bia2anime', 'golching', 'film2media'];
